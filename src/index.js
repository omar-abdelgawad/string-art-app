...
//   img.src = '/test_files/neko.jpg'; // Set the source of the image to the local file path
//   img.onload = function () { // Define the onload event handler for when the image is loaded
//     const canvas = document.getElementById('imageCanvas'); // Get the image canvas element
//     const ctx = canvas.getContext('2d'); // Get the 2D rendering context of the image canvas
//     canvas.width = img.width; // Set the width of the image canvas to the width of the image
//     canvas.height = img.height; // Set the height of the image canvas to the height of the image
//     ctx.drawImage(img, 0, 0); // Draw the image onto the image canvas
//   };
// });
